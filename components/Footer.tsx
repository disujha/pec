            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm text-gray-600">
                  ...
                  <div>Petrochem Engineering Construction</div>
                  <div>Barsundra, NH41 Highway</div>
                  <div>Purba Medinipur, West Bengal 721654</div>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-600">+91 22 6565 6222</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-5 h-5 text-primary flex-shrink-0">
                  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
